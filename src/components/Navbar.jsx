    ...
    return (
        <div className="h-full w-full">
          ...
          flex items-center px-6 md:px-16 justify-between"
            ...
            {/* Mobile Menu */}
            {menuOpen && (
                <div className="md:hidden bg-[#0f172a] border-t border-gray-700 flex flex-col items-center gap-6 py-6 text-gray-300 font-medium mt-[14%]">
                    <Link onClick={() => setMenuOpen(false)} className="hover:text-gray-100">Home</Link>
                    <Link onClick={() => setMenuOpen(false)} className="hover:text-gray-100">About</Link>
                    <Link onClick={() => setMenuOpen(false)} className="hover:text-gray-100">Services</Link>
                    <Link onClick={() => setMenuOpen(false)} className="hover:text-gray-100">Contact</Link>
                    <a
                        href="https://github.com/pathaksanchit25-coder"
                        target="_blank"
                        rel="noopener noreferrer"
